            ...
            <footer class="w-full bg-white p-8">
                <div
                    ...
                    <ul class="flex flex-wrap items-center gap-y-2 gap-x-8">
                        <li>
                            <a href="{{ route('about') }}" wire:navigate class="text-slate-700 hover:text-slate-500 focus:text-slate-500 text-sm">
                                About Us
                            </a>
                        </li>
                        <li>
                            <a href="https://mit-license.org/" target="_blank" class="text-slate-700 hover:text-slate-500 focus:text-slate-500 text-sm">
                                License
                            </a>
                        </li>
                        <li>
